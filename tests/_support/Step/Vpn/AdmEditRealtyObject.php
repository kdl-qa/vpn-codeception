...
/*========================================Edit Flat Object================================*/
    ...
    public function editFlatObject()
    {
        ...
        $I->fillField(AdmRealtyObject::$typeRegion, Flat::region);
...
/*====================================Edit House Object===================================*/
    ...
    public function editHouseObject()
    {
        ...
        $I->click(AdmRealtyObject::$objStatus1);
        $I->click(AdmRealtyObject::$regionField);
        $I->fillField(AdmRealtyObject::$typeRegion, House::region);
        $I->click(AdmRealtyObject::$region0);
        $I->click(AdmRealtyObject::$cityField);
        $I->fillField(AdmRealtyObject::$typeCity, House::city);
        $I->click(AdmRealtyObject::$city0);
        $I->click(AdmRealtyObject::$districtField);
...
/*====================================Edit Parcel Object===================================*/
    ...
    public function editParcelObject()
    {
        ...
        $I->click(AdmRealtyObject::$objStatus1);
        $I->click(AdmRealtyObject::$regionField);
        $I->fillField(AdmRealtyObject::$typeRegion, Parcel::region);
        $I->click(AdmRealtyObject::$region0);
        $I->click(AdmRealtyObject::$cityField);
...
/*====================================Edit Commercial Object===================================*/
    ...
    public function editCommercialObject()
    {
        ...
        $I->click(AdmRealtyObject::$objStatus1);
        $I->click(AdmRealtyObject::$regionField);
        $I->fillField(AdmRealtyObject::$typeRegion, Commercial::region);
        $I->click(AdmRealtyObject::$region0);
        $I->click(AdmRealtyObject::$cityField);
        $I->fillField(AdmRealtyObject::$typeCity, Commercial::city);
        $I->click(AdmRealtyObject::$city0);
        $I->click(AdmRealtyObject::$districtField);
        $I->click(AdmRealtyObject::$district3);
        $I->click(AdmRealtyObject::$street);
