...
/*=======================================Edit House=======================================*/
    ...
    const editDescriptionHouseSell = 'Продажа частного дома в центре города. Продажа дома без посредников от собственника. Дом вложений не требует.';
    const editDescriptionHouseRent = 'Аренда дома в центре города. Аренда дома без посредников. Дом вложений не требует. Хорошая транспортная розвязка.';
