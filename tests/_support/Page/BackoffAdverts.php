...
class BackoffAdverts
{
    // include url of current page
    public static $advListURL = '/admin/adverts';
    public static $authURL = '/admin/auth';

    public static $authEmail = '#email';
    public static $authPass = '#password';
    public static $loginButton = "//button[@type='submit']";
    public static $chooseFirstRow = "//a[@class='ui-select-choices-row-inner']";

    public static $advListEditLink0 = '.announcementList li:nth-child(2) .fa:nth-child(1)';
    public static $advStatusField = '[ng-model="ctrl.status"] span';
    public static $advStatus0 = '.cc-announcement-status0';
    public static $advStatus1 = '.cc-announcement-status1';
    public static $advStatus2 = '.cc-announcement-status2';
    public static $advStatus3 = '.cc-announcement-status3';
    public static $advStatus4 = '.cc-announcement-status4';

    public static $advEditSubmit = 'button.blue';

    public static $advEditUserName = '#userName';
    public static $advEditRealtyID = '#realtyID';
    public static $advOTSale = '[ng-model="ctrl.advert.operationType"]:first-child';
    public static $advOTRent = '[ng-model="ctrl.advert.operationType"]:last-child';
    public static $advDescription = '#description';

    public static $advPrice = '#price';
    public static $advCurrencyField = '[ng-model="ctrl.advert.currency"] span';
    public static $advCurrencyUS = '.cc-currency-name0';
    public static $advCurrencyUA = '.cc-currency-name1';

    public static $advCommission = '#commission';
    public static $advPeriodField = '[ng-model="ctrl.advert.period"] span';
    public static $advPeriodDay = '.cc-period-name0';
    public static $advPeriodMonth = '.cc-period-name1';

    public static $advAuction = '[ng-model="ctrl.advert.auction"] span';

    public static $dateField = '[ng-model="date.day"]';
    ...
    public static $yearField = '[ng-model="date.year"]';

    public static $advMarketField = '[ng-model="ctrl.advert.marketType"] span';
    public static $advMarket0 = '.cc-market-type0';
    public static $advMarket1 = '.cc-market-type1';

    public static $advRepairField = '[ng-model="ctrl.advert.repair"] span';
    ...
    public static $advOwnerName = '#ownerName';
    public static $advOwnerContacts = '#ownerContacts';
    public static $advOwnerLink = "//a[@class='dottedLink']";
